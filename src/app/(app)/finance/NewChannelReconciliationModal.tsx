...
export function NewChannelReconciliationModal({
  ...
  const [commissionShareCurrency, setCommissionShareCurrency] = useState("人民币");
  ...
  const selectedRec = monthlyRecs.find((r) => r.id === customerReconciliationId);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-2xl rounded-xl bg-white shadow-2xl">
        <div className="border-b border-slate-200 px-6 py-4">
          <h2 className="text-lg font-semibold text-slate-900">新建渠道分账</h2>
